  ...
  <div class="py-12">
    <div class="mx-auto max-w-5xl sm:px-6 lg:px-8">
      ...
      <form action="{{ route('summaries.generate') }}" method="POST" class="flex flex-col gap-8"
        ...
        <div class="flex w-full items-center justify-between">
          <div class="w-[50%]">
            <label for="summary-name"
              class="block text-sm/6 font-medium text-fg-secondry dark:text-fg-secondry-dark">Summary title</label>
            <div class="mt-2">
        ...
        <!-- Submit Button -->
        {{-- <div class="w-full">
          <button type="submit" class="w-full btn" :disabled="loading" @click="loading = true">
