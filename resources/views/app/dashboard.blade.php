                ...
                <div class="flex items-center justify-between w-full">
                    <div class="w-[50%]">
                        <label for="summary-name"
                            class="block font-medium text-sm/6 text-fg-secondry dark:text-fg-secondry-dark">Summary
                            title</label>
                        <div class="mt-2">
                            ...
                            <div class="relative mt-2">
                                <button @click="open = !open" @click.away="open = false" type="button"
                                    ...
                                    <span class="flex items-center">
                                        <div class="h-4 w-4 rounded-[4px]"
                                            :style="{ 'background-color': selected.color }"></div>
                                ...
                                <ul x-show="open" x-cloak
                                    ...
                                    @foreach ($folders as $folder)
                                        <li @click="selected = { id: '{{ $folder->id }}', name: '{{ $folder->name }}', color: '{{ $folder->color }}' }; open = false; $refs.folderInput.value = selected.id"
