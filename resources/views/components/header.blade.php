        ...
        <div x-data="{ modalOpen: false }" @keydown.escape.window="modalOpen = false" class="relative z-50 w-auto h-auto">
            ...
            <template x-teleport="body">
                <div x-show="modalOpen"
                    class="fixed left-0 top-0 z-[99] flex h-screen w-screen items-center justify-center" x-cloak>
                                ...
                                <div class="flex flex-col justify-between gap-4">
                                    <div class="flex items-center justify-between">
                                        <div class="w-full">
                                            ...
                                            <div class="mt-2">
                                                <input type="text" name="folder_name" id="first-name"
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-2">
                                                    <input type="color" name="folder_color"
                                                        class="w-8 h-8 p-0 border-none rounded-lg appearance-none cursor-pointer"
                                                        value="#8057DA" />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <input type="submit" value="Submit"
                                        class="text-white btn hover:bg-bg-secondry-dark dark:bg-bg-primary-dark" />
                                </div>
                            </form>
